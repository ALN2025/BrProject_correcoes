// Bytecode for: ext.mods.fakeplayer.model.OffensiveSpell
// File: ext\mods\fakeplayer\model\OffensiveSpell.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/fakeplayer/model/OffensiveSpell.class
  Last modified 9 de jul de 2026; size 800 bytes
  MD5 checksum a7084346dce628c4eacf5cd2c32456dc
  Compiled from "OffensiveSpell.java"
public class ext.mods.fakeplayer.model.OffensiveSpell extends ext.mods.fakeplayer.model.BotSkill
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #16                         // ext/mods/fakeplayer/model/OffensiveSpell
...
Constant pool:
  ...
  #15 = Utf8               (I)V
  #16 = Class              #17            // ext/mods/fakeplayer/model/OffensiveSpell
  #17 = Utf8               ext/mods/fakeplayer/model/OffensiveSpell
  #18 = Utf8               Code
  #19 = Utf8               LineNumberTable
  #20 = Utf8               LocalVariableTable
  #21 = Utf8               this
  #22 = Utf8               Lext/mods/fakeplayer/model/OffensiveSpell;
  #23 = Utf8               skillId
  #24 = Utf8               I
  #25 = Utf8               condition
  ...
  #28 = Utf8               (II)V
  #29 = Utf8               SourceFile
  #30 = Utf8               OffensiveSpell.java
{
  public ext.mods.fakeplayer.model.OffensiveSpell(int, ext.mods.fakeplayer.model.SpellUsageCondition, int, int);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      10     0  this   Lext/mods/fakeplayer/model/OffensiveSpell;
            0      10     1 skillId   I
            0      10     2 condition   Lext/mods/fakeplayer/model/SpellUsageCondition;
            0      10     3 conditionValue   I
            0      10     4 priority   I

  public ext.mods.fakeplayer.model.OffensiveSpell(int, int);
    descriptor: (II)V
    flags: (0x0001) ACC_PUBLIC
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      11     0  this   Lext/mods/fakeplayer/model/OffensiveSpell;
            0      11     1 skillId   I
            0      11     2 priority   I

  public ext.mods.fakeplayer.model.OffensiveSpell(int);
    descriptor: (I)V
    flags: (0x0001) ACC_PUBLIC
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       6     0  this   Lext/mods/fakeplayer/model/OffensiveSpell;
            0       6     1 skillId   I
}
SourceFile: "OffensiveSpell.java"
