// Bytecode for: ext.mods.fakeplayer.thirdclasses.ArchmageAI
// File: ext\mods\fakeplayer\thirdclasses\ArchmageAI.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/fakeplayer/thirdclasses/ArchmageAI.class
  Last modified 9 de jul de 2026; size 2683 bytes
  MD5 checksum bd363ea8e67328bffe86df204a517aaa
  Compiled from "ArchmageAI.java"
public class ext.mods.fakeplayer.thirdclasses.ArchmageAI extends ext.mods.fakeplayer.ai.CombatAI implements ext.mods.fakeplayer.ai.addon.IConsumableSpender,ext.mods.fakeplayer.ai.addon.IPotionUser
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #8                          // ext/mods/fakeplayer/thirdclasses/ArchmageAI
...
Constant pool:
    ...
    #7 = Fieldref           #8.#9         // ext/mods/fakeplayer/thirdclasses/ArchmageAI.CPPotion:I
    #8 = Class              #10           // ext/mods/fakeplayer/thirdclasses/ArchmageAI
    #9 = NameAndType        #11:#12       // CPPotion:I
   #10 = Utf8               ext/mods/fakeplayer/thirdclasses/ArchmageAI
   #11 = Utf8               CPPotion
   #12 = Utf8               I
   #13 = Fieldref           #8.#14        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.HPPotion:I
   #14 = NameAndType        #15:#12       // HPPotion:I
   #15 = Utf8               HPPotion
   #16 = Fieldref           #8.#17        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.MPPotion:I
   ...
   #21 = Utf8               thinkAndAct
   #22 = Utf8               ()V
   #23 = Methodref          #8.#24        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.setBusyThinking:(Z)V
   #24 = NameAndType        #25:#26       // setBusyThinking:(Z)V
   #25 = Utf8               setBusyThinking
   #26 = Utf8               (Z)V
   #27 = Methodref          #8.#28        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.applyDefaultBuffs:()V
   #28 = NameAndType        #29:#22       // applyDefaultBuffs:()V
   #29 = Utf8               applyDefaultBuffs
   #30 = Fieldref           #8.#31        // ext/mods/fakeplayer/thirdclasses/ArchmageAI._fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #31 = NameAndType        #32:#33       // _fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #32 = Utf8               _fakePlayer
   #33 = Utf8               Lext/mods/fakeplayer/FakePlayer;
   #34 = Methodref          #8.#35        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.handleConsumable:(Lext/mods/fakeplayer/FakePlayer;I)V
   ...
   #38 = Methodref          #8.#39        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.handlePotions:(Lext/mods/fakeplayer/FakePlayer;III)V
   ...
   #42 = Methodref          #8.#43        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.handleShots:()V
   ...
   #54 = Utf8               ()I
   #55 = Methodref          #8.#56        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.tryTargetNearestCreatureByTypeInRadius:(Ljava/lang/Class;I)V
   ...
   #59 = Methodref          #8.#60        // ext/mods/fakeplayer/thirdclasses/ArchmageAI.tryAttackingUsingMageOffensiveSkill:()V
  ...
  #104 = Utf8               this
  #105 = Utf8               Lext/mods/fakeplayer/thirdclasses/ArchmageAI;
  #106 = Utf8               character
  ...
  #121 = Utf8               SourceFile
  #122 = Utf8               ArchmageAI.java
{
  public ext.mods.fakeplayer.thirdclasses.ArchmageAI(ext.mods.fakeplayer.FakePlayer);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      27     0  this   Lext/mods/fakeplayer/thirdclasses/ArchmageAI;
  ...
  public void thinkAndAct();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      87     0  this   Lext/mods/fakeplayer/thirdclasses/ArchmageAI;
  ...
  protected ext.mods.gameserver.enums.items.ShotType getShotType();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/fakeplayer/thirdclasses/ArchmageAI;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.OffensiveSpell> getOffensiveSpells();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      44     0  this   Lext/mods/fakeplayer/thirdclasses/ArchmageAI;
            8      36     1 _offensiveSpells   Ljava/util/List;
      LocalVariableTypeTable:
        Start  Length  Slot  Name   Signature
            8      36     1 _offensiveSpells   Ljava/util/List<Lext/mods/fakeplayer/model/OffensiveSpell;>;
