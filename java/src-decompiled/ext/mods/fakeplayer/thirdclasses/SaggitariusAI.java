// Bytecode for: ext.mods.fakeplayer.thirdclasses.SaggitariusAI
// File: ext\mods\fakeplayer\thirdclasses\SaggitariusAI.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/fakeplayer/thirdclasses/SaggitariusAI.class
  Last modified 9 de jul de 2026; size 3011 bytes
  MD5 checksum ec52f45b2c816808207a9aa538f2eb45
  Compiled from "SaggitariusAI.java"
public class ext.mods.fakeplayer.thirdclasses.SaggitariusAI extends ext.mods.fakeplayer.ai.CombatAI implements ext.mods.fakeplayer.ai.addon.IConsumableSpender,ext.mods.fakeplayer.ai.addon.IPotionUser
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #8                          // ext/mods/fakeplayer/thirdclasses/SaggitariusAI
...
Constant pool:
    ...
    #7 = Fieldref           #8.#9         // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.CPPotion:I
    #8 = Class              #10           // ext/mods/fakeplayer/thirdclasses/SaggitariusAI
    #9 = NameAndType        #11:#12       // CPPotion:I
   #10 = Utf8               ext/mods/fakeplayer/thirdclasses/SaggitariusAI
   #11 = Utf8               CPPotion
   #12 = Utf8               I
   #13 = Fieldref           #8.#14        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.HPPotion:I
   #14 = NameAndType        #15:#12       // HPPotion:I
   #15 = Utf8               HPPotion
   #16 = Fieldref           #8.#17        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.MPPotion:I
   ...
   #21 = Utf8               thinkAndAct
   #22 = Utf8               ()V
   #23 = Methodref          #8.#24        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.setBusyThinking:(Z)V
   #24 = NameAndType        #25:#26       // setBusyThinking:(Z)V
   #25 = Utf8               setBusyThinking
   #26 = Utf8               (Z)V
   #27 = Methodref          #8.#28        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.applyDefaultBuffs:()V
   #28 = NameAndType        #29:#22       // applyDefaultBuffs:()V
   #29 = Utf8               applyDefaultBuffs
   #30 = Fieldref           #8.#31        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI._fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #31 = NameAndType        #32:#33       // _fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #32 = Utf8               _fakePlayer
   #33 = Utf8               Lext/mods/fakeplayer/FakePlayer;
   #34 = Methodref          #8.#35        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.getArrowId:()I
   #35 = NameAndType        #36:#37       // getArrowId:()I
   #36 = Utf8               getArrowId
   #37 = Utf8               ()I
   #38 = Methodref          #8.#39        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.handleConsumable:(Lext/mods/fakeplayer/FakePlayer;I)V
   ...
   #42 = Methodref          #8.#43        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.handlePotions:(Lext/mods/fakeplayer/FakePlayer;III)V
   ...
   #46 = Methodref          #8.#47        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.handleShots:()V
   ...
   #58 = Methodref          #8.#59        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.tryTargetNearestCreatureByTypeInRadius:(Ljava/lang/Class;I)V
   ...
   #62 = Methodref          #8.#63        // ext/mods/fakeplayer/thirdclasses/SaggitariusAI.tryAttackingUsingFighterOffensiveSkill:()V
  ...
  #100 = Methodref          #98.#82       // ext/mods/fakeplayer/model/SupportSpell."<init>":(I)V
  #101 = Class              #102          // ext/mods/fakeplayer/ai/addon/IConsumableSpender
  #102 = Utf8               ext/mods/fakeplayer/ai/addon/IConsumableSpender
  #103 = Class              #104          // ext/mods/fakeplayer/ai/addon/IPotionUser
  #104 = Utf8               ext/mods/fakeplayer/ai/addon/IPotionUser
  ...
  #112 = Utf8               this
  #113 = Utf8               Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
  #114 = Utf8               character
  #115 = Utf8               getShotType
  #116 = Utf8               ()Lext/mods/gameserver/enums/items/ShotType;
  #117 = Utf8               getBuffs
  #118 = Utf8               getOffensiveSpells
  #119 = Utf8               _offensiveSpells
  #120 = Utf8               Ljava/util/List;
  #121 = Utf8               LocalVariableTypeTable
  #122 = Utf8               Ljava/util/List<Lext/mods/fakeplayer/model/OffensiveSpell;>;
  #123 = Utf8               Signature
  #124 = Utf8               ()Ljava/util/List<Lext/mods/fakeplayer/model/OffensiveSpell;>;
  #125 = Utf8               changeOfUsingSkill
  #126 = Utf8               ()D
  #127 = Utf8               getHealingSpells
  #128 = Utf8               ()Ljava/util/List<Lext/mods/fakeplayer/model/HealingSpell;>;
  #129 = Utf8               getSelfSupportSpells
  #130 = Utf8               _selfSupportSpells
  #131 = Utf8               Ljava/util/List<Lext/mods/fakeplayer/model/SupportSpell;>;
  #132 = Utf8               ()Ljava/util/List<Lext/mods/fakeplayer/model/SupportSpell;>;
  #133 = Utf8               SourceFile
  #134 = Utf8               SaggitariusAI.java
{
  public ext.mods.fakeplayer.thirdclasses.SaggitariusAI(ext.mods.fakeplayer.FakePlayer);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      27     0  this   Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
  ...
  public void thinkAndAct();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      99     0  this   Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
  ...
  protected ext.mods.gameserver.enums.items.ShotType getShotType();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.OffensiveSpell> getOffensiveSpells();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      43     0  this   Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
    ...
    Signature: #124                         // ()Ljava/util/List<Lext/mods/fakeplayer/model/OffensiveSpell;>;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.HealingSpell> getHealingSpells();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
    Signature: #128                         // ()Ljava/util/List<Lext/mods/fakeplayer/model/HealingSpell;>;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.SupportSpell> getSelfSupportSpells();
    ...
    Code:
      stack=4, locals=2, args_size=1
        ...
        12: dup
        13: bipush        99
        15: invokespecial #100                // Method ext/mods/fakeplayer/model/SupportSpell."<init>":(I)V
        18: invokeinterface #84,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
        23: pop
        24: aload_1
        25: areturn
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      26     0  this   Lext/mods/fakeplayer/thirdclasses/SaggitariusAI;
            8      18     1 _selfSupportSpells   Ljava/util/List;
      LocalVariableTypeTable:
        Start  Length  Slot  Name   Signature
            8      18     1 _selfSupportSpells   Ljava/util/List<Lext/mods/fakeplayer/model/SupportSpell;>;
    Signature: #132                         // ()Ljava/util/List<Lext/mods/fakeplayer/model/SupportSpell;>;
}
SourceFile: "SaggitariusAI.java"
