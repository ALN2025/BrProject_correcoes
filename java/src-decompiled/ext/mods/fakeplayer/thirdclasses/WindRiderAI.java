// Bytecode for: ext.mods.fakeplayer.thirdclasses.WindRiderAI
// File: ext\mods\fakeplayer\thirdclasses\WindRiderAI.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/fakeplayer/thirdclasses/WindRiderAI.class
  Last modified 9 de jul de 2026; size 2785 bytes
  MD5 checksum 90937313921262e96409b29e59e4c096
  Compiled from "WindRiderAI.java"
public class ext.mods.fakeplayer.thirdclasses.WindRiderAI extends ext.mods.fakeplayer.ai.CombatAI implements ext.mods.fakeplayer.ai.addon.IConsumableSpender,ext.mods.fakeplayer.ai.addon.IPotionUser
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #8                          // ext/mods/fakeplayer/thirdclasses/WindRiderAI
...
Constant pool:
    ...
    #7 = Fieldref           #8.#9         // ext/mods/fakeplayer/thirdclasses/WindRiderAI.CPPotion:I
    #8 = Class              #10           // ext/mods/fakeplayer/thirdclasses/WindRiderAI
    #9 = NameAndType        #11:#12       // CPPotion:I
   #10 = Utf8               ext/mods/fakeplayer/thirdclasses/WindRiderAI
   #11 = Utf8               CPPotion
   #12 = Utf8               I
   #13 = Fieldref           #8.#14        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.HPPotion:I
   #14 = NameAndType        #15:#12       // HPPotion:I
   #15 = Utf8               HPPotion
   #16 = Fieldref           #8.#17        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.MPPotion:I
   ...
   #21 = Utf8               thinkAndAct
   #22 = Utf8               ()V
   #23 = Methodref          #8.#24        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.setBusyThinking:(Z)V
   #24 = NameAndType        #25:#26       // setBusyThinking:(Z)V
   #25 = Utf8               setBusyThinking
   #26 = Utf8               (Z)V
   #27 = Methodref          #8.#28        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.applyDefaultBuffs:()V
   #28 = NameAndType        #29:#22       // applyDefaultBuffs:()V
   #29 = Utf8               applyDefaultBuffs
   #30 = Fieldref           #8.#31        // ext/mods/fakeplayer/thirdclasses/WindRiderAI._fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #31 = NameAndType        #32:#33       // _fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #32 = Utf8               _fakePlayer
   #33 = Utf8               Lext/mods/fakeplayer/FakePlayer;
   #34 = Methodref          #8.#35        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.handleConsumable:(Lext/mods/fakeplayer/FakePlayer;I)V
   ...
   #38 = Methodref          #8.#39        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.handlePotions:(Lext/mods/fakeplayer/FakePlayer;III)V
   ...
   #42 = Methodref          #8.#43        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.handleShots:()V
   ...
   #54 = Utf8               ()I
   #55 = Methodref          #8.#56        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.tryTargetNearestCreatureByTypeInRadius:(Ljava/lang/Class;I)V
   ...
   #59 = Methodref          #8.#60        // ext/mods/fakeplayer/thirdclasses/WindRiderAI.tryAttackingUsingFighterOffensiveSkill:()V
  ...
  #104 = Utf8               this
  #105 = Utf8               Lext/mods/fakeplayer/thirdclasses/WindRiderAI;
  #106 = Utf8               character
  ...
  #121 = Utf8               SourceFile
  #122 = Utf8               WindRiderAI.java
{
  public ext.mods.fakeplayer.thirdclasses.WindRiderAI(ext.mods.fakeplayer.FakePlayer);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      27     0  this   Lext/mods/fakeplayer/thirdclasses/WindRiderAI;
  ...
  public void thinkAndAct();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      87     0  this   Lext/mods/fakeplayer/thirdclasses/WindRiderAI;
  ...
  protected ext.mods.gameserver.enums.items.ShotType getShotType();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/fakeplayer/thirdclasses/WindRiderAI;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.OffensiveSpell> getOffensiveSpells();
    ...
    Code:
      stack=4, locals=2, args_size=1
        ...
        45: dup
        46: sipush        410
        49: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
        52: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
        57: pop
        58: aload_1
        59: new           #76                 // class ext/mods/fakeplayer/model/OffensiveSpell
        62: dup
        63: bipush        102
        ...
        78: dup
        79: sipush        321
        82: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
        85: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
        90: pop
        91: aload_1
        92: new           #76                 // class ext/mods/fakeplayer/model/OffensiveSpell
        95: dup
        96: sipush        344
        99: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
       102: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
       107: pop
       108: aload_1
       109: new           #76                 // class ext/mods/fakeplayer/model/OffensiveSpell
       112: dup
       113: sipush        358
       116: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
       119: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
       124: pop
       125: aload_1
       126: areturn
      LineNumberTable:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0     127     0  this   Lext/mods/fakeplayer/thirdclasses/WindRiderAI;
            8     119     1 _offensiveSpells   Ljava/util/List;
      LocalVariableTypeTable:
        Start  Length  Slot  Name   Signature
            8     119     1 _offensiveSpells   Ljava/util/List<Lext/mods/fakeplayer/model/OffensiveSpell;>;
