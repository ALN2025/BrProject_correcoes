// Bytecode for: ext.mods.fakeplayer.thirdclasses.AdventurerAI
// File: ext\mods\fakeplayer\thirdclasses\AdventurerAI.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/fakeplayer/thirdclasses/AdventurerAI.class
  Last modified 9 de jul de 2026; size 2786 bytes
  MD5 checksum 03146586ca6f82953cc829d2ca8a4f0e
  Compiled from "AdventurerAI.java"
public class ext.mods.fakeplayer.thirdclasses.AdventurerAI extends ext.mods.fakeplayer.ai.CombatAI implements ext.mods.fakeplayer.ai.addon.IConsumableSpender,ext.mods.fakeplayer.ai.addon.IPotionUser
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #8                          // ext/mods/fakeplayer/thirdclasses/AdventurerAI
...
Constant pool:
    ...
    #7 = Fieldref           #8.#9         // ext/mods/fakeplayer/thirdclasses/AdventurerAI.CPPotion:I
    #8 = Class              #10           // ext/mods/fakeplayer/thirdclasses/AdventurerAI
    #9 = NameAndType        #11:#12       // CPPotion:I
   #10 = Utf8               ext/mods/fakeplayer/thirdclasses/AdventurerAI
   #11 = Utf8               CPPotion
   #12 = Utf8               I
   #13 = Fieldref           #8.#14        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.HPPotion:I
   #14 = NameAndType        #15:#12       // HPPotion:I
   #15 = Utf8               HPPotion
   #16 = Fieldref           #8.#17        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.MPPotion:I
   ...
   #21 = Utf8               thinkAndAct
   #22 = Utf8               ()V
   #23 = Methodref          #8.#24        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.setBusyThinking:(Z)V
   #24 = NameAndType        #25:#26       // setBusyThinking:(Z)V
   #25 = Utf8               setBusyThinking
   #26 = Utf8               (Z)V
   #27 = Methodref          #8.#28        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.applyDefaultBuffs:()V
   #28 = NameAndType        #29:#22       // applyDefaultBuffs:()V
   #29 = Utf8               applyDefaultBuffs
   #30 = Fieldref           #8.#31        // ext/mods/fakeplayer/thirdclasses/AdventurerAI._fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #31 = NameAndType        #32:#33       // _fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #32 = Utf8               _fakePlayer
   #33 = Utf8               Lext/mods/fakeplayer/FakePlayer;
   #34 = Methodref          #8.#35        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.handleConsumable:(Lext/mods/fakeplayer/FakePlayer;I)V
   ...
   #38 = Methodref          #8.#39        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.handlePotions:(Lext/mods/fakeplayer/FakePlayer;III)V
   ...
   #42 = Methodref          #8.#43        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.handleShots:()V
   ...
   #54 = Utf8               ()I
   #55 = Methodref          #8.#56        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.tryTargetNearestCreatureByTypeInRadius:(Ljava/lang/Class;I)V
   ...
   #59 = Methodref          #8.#60        // ext/mods/fakeplayer/thirdclasses/AdventurerAI.tryAttackingUsingFighterOffensiveSkill:()V
  ...
  #104 = Utf8               this
  #105 = Utf8               Lext/mods/fakeplayer/thirdclasses/AdventurerAI;
  #106 = Utf8               character
  ...
  #121 = Utf8               SourceFile
  #122 = Utf8               AdventurerAI.java
{
  public ext.mods.fakeplayer.thirdclasses.AdventurerAI(ext.mods.fakeplayer.FakePlayer);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      27     0  this   Lext/mods/fakeplayer/thirdclasses/AdventurerAI;
  ...
  public void thinkAndAct();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      87     0  this   Lext/mods/fakeplayer/thirdclasses/AdventurerAI;
  ...
  protected ext.mods.gameserver.enums.items.ShotType getShotType();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/fakeplayer/thirdclasses/AdventurerAI;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.OffensiveSpell> getOffensiveSpells();
    ...
    Code:
      stack=4, locals=2, args_size=1
        ...
        61: dup
        62: iconst_4
        63: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
        66: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
        71: pop
        72: aload_1
        73: new           #76                 // class ext/mods/fakeplayer/model/OffensiveSpell
        76: dup
        77: sipush        409
        80: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
        83: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
        88: pop
        89: aload_1
        90: new           #76                 // class ext/mods/fakeplayer/model/OffensiveSpell
        93: dup
        94: sipush        344
        97: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
       100: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
       105: pop
       106: aload_1
       107: new           #76                 // class ext/mods/fakeplayer/model/OffensiveSpell
       110: dup
       111: sipush        358
       114: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
       117: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
       122: pop
       123: aload_1
       124: areturn
      LineNumberTable:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0     125     0  this   Lext/mods/fakeplayer/thirdclasses/AdventurerAI;
            8     117     1 _offensiveSpells   Ljava/util/List;
      LocalVariableTypeTable:
        Start  Length  Slot  Name   Signature
            8     117     1 _offensiveSpells   Ljava/util/List<Lext/mods/fakeplayer/model/OffensiveSpell;>;
