// Bytecode for: ext.mods.fakeplayer.thirdclasses.MysticMuseAI
// File: ext\mods\fakeplayer\thirdclasses\MysticMuseAI.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/fakeplayer/thirdclasses/MysticMuseAI.class
  Last modified 9 de jul de 2026; size 2731 bytes
  MD5 checksum a43065cc7a0f3c2791815986d0a18e64
  Compiled from "MysticMuseAI.java"
public class ext.mods.fakeplayer.thirdclasses.MysticMuseAI extends ext.mods.fakeplayer.ai.CombatAI implements ext.mods.fakeplayer.ai.addon.IConsumableSpender,ext.mods.fakeplayer.ai.addon.IPotionUser
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #8                          // ext/mods/fakeplayer/thirdclasses/MysticMuseAI
...
Constant pool:
    ...
    #7 = Fieldref           #8.#9         // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.CPPotion:I
    #8 = Class              #10           // ext/mods/fakeplayer/thirdclasses/MysticMuseAI
    #9 = NameAndType        #11:#12       // CPPotion:I
   #10 = Utf8               ext/mods/fakeplayer/thirdclasses/MysticMuseAI
   #11 = Utf8               CPPotion
   #12 = Utf8               I
   #13 = Fieldref           #8.#14        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.HPPotion:I
   #14 = NameAndType        #15:#12       // HPPotion:I
   #15 = Utf8               HPPotion
   #16 = Fieldref           #8.#17        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.MPPotion:I
   ...
   #21 = Utf8               thinkAndAct
   #22 = Utf8               ()V
   #23 = Methodref          #8.#24        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.setBusyThinking:(Z)V
   #24 = NameAndType        #25:#26       // setBusyThinking:(Z)V
   #25 = Utf8               setBusyThinking
   #26 = Utf8               (Z)V
   #27 = Methodref          #8.#28        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.applyDefaultBuffs:()V
   #28 = NameAndType        #29:#22       // applyDefaultBuffs:()V
   #29 = Utf8               applyDefaultBuffs
   #30 = Fieldref           #8.#31        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI._fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #31 = NameAndType        #32:#33       // _fakePlayer:Lext/mods/fakeplayer/FakePlayer;
   #32 = Utf8               _fakePlayer
   #33 = Utf8               Lext/mods/fakeplayer/FakePlayer;
   #34 = Methodref          #8.#35        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.handleConsumable:(Lext/mods/fakeplayer/FakePlayer;I)V
   ...
   #38 = Methodref          #8.#39        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.handlePotions:(Lext/mods/fakeplayer/FakePlayer;III)V
   ...
   #42 = Methodref          #8.#43        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.handleShots:()V
   ...
   #54 = Utf8               ()I
   #55 = Methodref          #8.#56        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.tryTargetNearestCreatureByTypeInRadius:(Ljava/lang/Class;I)V
   ...
   #59 = Methodref          #8.#60        // ext/mods/fakeplayer/thirdclasses/MysticMuseAI.tryAttackingUsingMageOffensiveSkill:()V
  ...
  #104 = Utf8               this
  #105 = Utf8               Lext/mods/fakeplayer/thirdclasses/MysticMuseAI;
  #106 = Utf8               character
  ...
  #121 = Utf8               SourceFile
  #122 = Utf8               MysticMuseAI.java
{
  public ext.mods.fakeplayer.thirdclasses.MysticMuseAI(ext.mods.fakeplayer.FakePlayer);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      27     0  this   Lext/mods/fakeplayer/thirdclasses/MysticMuseAI;
  ...
  public void thinkAndAct();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      87     0  this   Lext/mods/fakeplayer/thirdclasses/MysticMuseAI;
  ...
  protected ext.mods.gameserver.enums.items.ShotType getShotType();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/fakeplayer/thirdclasses/MysticMuseAI;
  ...
  protected java.util.List<ext.mods.fakeplayer.model.OffensiveSpell> getOffensiveSpells();
    ...
    Code:
      stack=4, locals=2, args_size=1
        ...
        63: dup
        64: sipush        1265
        67: invokespecial #78                 // Method ext/mods/fakeplayer/model/OffensiveSpell."<init>":(I)V
        70: invokeinterface #81,  2           // InterfaceMethod java/util/List.add:(Ljava/lang/Object;)Z
        75: pop
        76: aload_1
        77: areturn
      LineNumberTable:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      78     0  this   Lext/mods/fakeplayer/thirdclasses/MysticMuseAI;
