// Bytecode for: ext.mods.gameserver.model.actor.Player$2
// File: ext\mods\gameserver\model\actor\Player$2.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/gameserver/model/actor/Player$2.class
  Last modified 9 de jul de 2026; size 1120 bytes
  MD5 checksum b5a0ecd04e3104898fd76044d5005da8
  Compiled from "Player.java"
class ext.mods.gameserver.model.actor.Player$2 implements java.lang.Runnable
  minor version: 0
  major version: 69
  flags: (0x0020) ACC_SUPER
  this_class: #2                          // ext/mods/gameserver/model/actor/Player$2
  super_class: #8                         // java/lang/Object
  interfaces: 1, fields: 1, methods: 2, attributes: 4
Constant pool:
   #1 = Fieldref           #2.#3          // ext/mods/gameserver/model/actor/Player$2.val$player:Lext/mods/gameserver/model/actor/Player;
   #2 = Class              #4             // ext/mods/gameserver/model/actor/Player$2
   #3 = NameAndType        #5:#6          // val$player:Lext/mods/gameserver/model/actor/Player;
   #4 = Utf8               ext/mods/gameserver/model/actor/Player$2
   #5 = Utf8               val$player
  ...
  #50 = Utf8               this
  #51 = Utf8               Lext/mods/gameserver/model/actor/Player$2;
  #52 = Utf8               Signature
  #53 = Utf8               run
  ...
  #58 = NameAndType        #59:#60        // restore:(IZ)Lext/mods/gameserver/model/actor/Player;
  #59 = Utf8               restore
  #60 = Utf8               (IZ)Lext/mods/gameserver/model/actor/Player;
  #61 = Utf8               NestHost
  #62 = Utf8               InnerClasses
{
  ...
  ext.mods.gameserver.model.actor.Player$2();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      10     0  this   Lext/mods/gameserver/model/actor/Player$2;
    Signature: #12                          // ()V
  ...
  public void run();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      72     0  this   Lext/mods/gameserver/model/actor/Player$2;
      StackMapTable: number_of_entries = 1
        frame_type = 251 /* same_frame_extended */
          offset_delta = 71
}
SourceFile: "Player.java"
EnclosingMethod: #14.#58                // ext.mods.gameserver.model.actor.Player.restore
NestHost: class ext/mods/gameserver/model/actor/Player
InnerClasses:
  #2;                                     // class ext/mods/gameserver/model/actor/Player$2
