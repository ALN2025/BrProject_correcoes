// Bytecode for: ext.mods.gameserver.handler.itemhandlers.SkillMeditation
// File: ext\mods\gameserver\handler\itemhandlers\SkillMeditation.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/gameserver/handler/itemhandlers/SkillMeditation.class
  Last modified 9 de jul de 2026; size 2289 bytes
  MD5 checksum 969d7b0c657381b4e10ca6b1d3ad4909
  Compiled from "SkillMeditation.java"
public class ext.mods.gameserver.handler.itemhandlers.SkillMeditation implements ext.mods.gameserver.handler.IItemHandler
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #8                          // ext/mods/gameserver/handler/itemhandlers/SkillMeditation
...
Constant pool:
    ...
    #5 = Utf8               <init>
    #6 = Utf8               ()V
    #7 = Fieldref           #8.#9         // ext/mods/gameserver/handler/itemhandlers/SkillMeditation.clanSkills:[I
    #8 = Class              #10           // ext/mods/gameserver/handler/itemhandlers/SkillMeditation
    #9 = NameAndType        #11:#12       // clanSkills:[I
   #10 = Utf8               ext/mods/gameserver/handler/itemhandlers/SkillMeditation
   #11 = Utf8               clanSkills
   #12 = Utf8               [I
   ...
   #84 = Utf8               this
   #85 = Utf8               Lext/mods/gameserver/handler/itemhandlers/SkillMeditation;
   #86 = Utf8               useItem
  ...
  #107 = Utf8               SourceFile
  #108 = Utf8               SkillMeditation.java
{
  public ext.mods.gameserver.handler.itemhandlers.SkillMeditation();
    descriptor: ()V
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      18     0  this   Lext/mods/gameserver/handler/itemhandlers/SkillMeditation;
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
           ...
           13     134     4 player   Lext/mods/gameserver/model/actor/Player;
            0     148     0  this   Lext/mods/gameserver/handler/itemhandlers/SkillMeditation;
      ...
      StackMapTable: number_of_entries = 5
        frame_type = 255 /* full_frame */
          offset_delta = 35
          locals = [ class ext/mods/gameserver/handler/itemhandlers/SkillMeditation, class ext/mods/gameserver/model/actor/Playable, class ext/mods/gameserver/model/item/instance/ItemInstance, int, class ext/mods/gameserver/model/actor/Player, class "[I", int, int ]
          stack = []
...
SourceFile: "SkillMeditation.java"
