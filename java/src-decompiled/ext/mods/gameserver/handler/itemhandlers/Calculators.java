// Bytecode for: ext.mods.gameserver.handler.itemhandlers.Calculators
// File: ext\mods\gameserver\handler\itemhandlers\Calculators.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/gameserver/handler/itemhandlers/Calculators.class
  Last modified 9 de jul de 2026; size 1171 bytes
  MD5 checksum cb0f6be448c3f0aa7419d3173d39ca4b
  Compiled from "Calculators.java"
public class ext.mods.gameserver.handler.itemhandlers.Calculators implements ext.mods.gameserver.handler.IItemHandler
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #24                         // ext/mods/gameserver/handler/itemhandlers/Calculators
...
Constant pool:
   ...
   #9 = Class              #10            // ext/mods/gameserver/network/serverpackets/ShowCalculator
  #10 = Utf8               ext/mods/gameserver/network/serverpackets/ShowCalculator
  ...
  #15 = Utf8               getItemId
  #16 = Utf8               ()I
  #17 = Methodref          #9.#18         // ext/mods/gameserver/network/serverpackets/ShowCalculator."<init>":(I)V
  ...
  #24 = Class              #25            // ext/mods/gameserver/handler/itemhandlers/Calculators
  #25 = Utf8               ext/mods/gameserver/handler/itemhandlers/Calculators
  ...
  #31 = Utf8               this
  #32 = Utf8               Lext/mods/gameserver/handler/itemhandlers/Calculators;
  #33 = Utf8               useItem
  ...
  #44 = Utf8               SourceFile
  #45 = Utf8               Calculators.java
{
  public ext.mods.gameserver.handler.itemhandlers.Calculators();
    descriptor: ()V
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lext/mods/gameserver/handler/itemhandlers/Calculators;
  ...
  public void useItem(ext.mods.gameserver.model.actor.Playable, ext.mods.gameserver.model.item.instance.ItemInstance, boolean);
    ...
    Code:
      stack=4, locals=5, args_size=4
        ...
        16: return
        17: aload         4
        19: new           #9                  // class ext/mods/gameserver/network/serverpackets/ShowCalculator
        22: dup
        23: aload_2
        24: invokevirtual #11                 // Method ext/mods/gameserver/model/item/instance/ItemInstance.getItemId:()I
        27: invokespecial #17                 // Method ext/mods/gameserver/network/serverpackets/ShowCalculator."<init>":(I)V
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
           13       3     4 player   Lext/mods/gameserver/model/actor/Player;
            0      34     0  this   Lext/mods/gameserver/handler/itemhandlers/Calculators;
