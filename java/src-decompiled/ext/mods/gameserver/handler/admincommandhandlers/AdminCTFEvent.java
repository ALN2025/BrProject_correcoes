// Bytecode for: ext.mods.gameserver.handler.admincommandhandlers.AdminCTFEvent
// File: ext\mods\gameserver\handler\admincommandhandlers\AdminCTFEvent.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent.class
  Last modified 9 de jul de 2026; size 2949 bytes
  MD5 checksum 90e459573a29afc3e8bef503a63c4e46
  Compiled from "AdminCTFEvent.java"
public class ext.mods.gameserver.handler.admincommandhandlers.AdminCTFEvent implements ext.mods.gameserver.handler.IAdminCommandHandler
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #30                         // ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent
...
Constant pool:
    ...
    #5 = Utf8               <init>
    #6 = Utf8               ()V
    #7 = String             #8            // admin_ctf_add
    #8 = Utf8               admin_ctf_add
   ...
   #29 = Methodref          #30.#31       // ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent.add:(Lext/mods/gameserver/model/actor/Player;Lext/mods/gameserver/model/actor/Player;)V
   #30 = Class              #32           // ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent
   #31 = NameAndType        #33:#34       // add:(Lext/mods/gameserver/model/actor/Player;Lext/mods/gameserver/model/actor/Player;)V
   #32 = Utf8               ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent
   #33 = Utf8               add
   #34 = Utf8               (Lext/mods/gameserver/model/actor/Player;Lext/mods/gameserver/model/actor/Player;)V
   #35 = String             #36           // admin_ctf_remove
   #36 = Utf8               admin_ctf_remove
   #37 = Methodref          #30.#38       // ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent.remove:(Lext/mods/gameserver/model/actor/Player;Lext/mods/gameserver/model/actor/Player;)V
   #38 = NameAndType        #39:#34       // remove:(Lext/mods/gameserver/model/actor/Player;Lext/mods/gameserver/model/actor/Player;)V
   #39 = Utf8               remove
   #40 = String             #41           // admin_ctf_advance
   #41 = Utf8               admin_ctf_advance
   #42 = Methodref          #43.#44       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFManager.getInstance:()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFManager;
   #43 = Class              #45           // ext/mods/gameserver/model/entity/events/capturetheflag/CTFManager
   #44 = NameAndType        #46:#47       // getInstance:()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFManager;
   #45 = Utf8               ext/mods/gameserver/model/entity/events/capturetheflag/CTFManager
   #46 = Utf8               getInstance
   #47 = Utf8               ()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFManager;
   #48 = Methodref          #43.#49       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFManager.skipDelay:()V
   #49 = NameAndType        #50:#6        // skipDelay:()V
   #50 = Utf8               skipDelay
   #51 = Fieldref           #30.#52       // ext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent.ADMIN_COMMANDS:[Ljava/lang/String;
   #52 = NameAndType        #53:#54       // ADMIN_COMMANDS:[Ljava/lang/String;
   #53 = Utf8               ADMIN_COMMANDS
   #54 = Utf8               [Ljava/lang/String;
   #55 = Methodref          #56.#57       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent.getInstance:()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent;
   #56 = Class              #58           // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent
   #57 = NameAndType        #46:#59       // getInstance:()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent;
   #58 = Utf8               ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent
   #59 = Utf8               ()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent;
   #60 = Methodref          #16.#61       // ext/mods/gameserver/model/actor/Player.getObjectId:()I
   #61 = NameAndType        #62:#63       // getObjectId:()I
   #62 = Utf8               getObjectId
   #63 = Utf8               ()I
   #64 = Methodref          #56.#65       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent.isPlayerParticipant:(I)Z
   #65 = NameAndType        #66:#67       // isPlayerParticipant:(I)Z
   #66 = Utf8               isPlayerParticipant
   #67 = Utf8               (I)Z
   #68 = Methodref          #56.#69       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent.addParticipant:(Lext/mods/gameserver/model/actor/Player;)Z
   ...
   #72 = Methodref          #56.#73       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent.isStarted:()Z
   #73 = NameAndType        #74:#75       // isStarted:()Z
   #74 = Utf8               isStarted
   #75 = Utf8               ()Z
   #76 = Class              #77           // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEventTeleporter
   #77 = Utf8               ext/mods/gameserver/model/entity/events/capturetheflag/CTFEventTeleporter
   #78 = Methodref          #56.#79       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent.getParticipantTeamCoordinates:(I)[I
   #79 = NameAndType        #80:#81       // getParticipantTeamCoordinates:(I)[I
   #80 = Utf8               getParticipantTeamCoordinates
   #81 = Utf8               (I)[I
   #82 = Methodref          #76.#83       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEventTeleporter."<init>":(Lext/mods/gameserver/model/actor/Player;[IZZ)V
   ...
   #85 = Methodref          #56.#86       // ext/mods/gameserver/model/entity/events/capturetheflag/CTFEvent.removeParticipant:(I)Z
   #86 = NameAndType        #87:#67       // removeParticipant:(I)Z
   #87 = Utf8               removeParticipant
   #88 = Fieldref           #89.#90       // ext/mods/Config.CTF_EVENT_PARTICIPATION_NPC_COORDINATES:[I
   #89 = Class              #91           // ext/mods/Config
   #90 = NameAndType        #92:#93       // CTF_EVENT_PARTICIPATION_NPC_COORDINATES:[I
   #91 = Utf8               ext/mods/Config
   #92 = Utf8               CTF_EVENT_PARTICIPATION_NPC_COORDINATES
   #93 = Utf8               [I
   ...
   #99 = Utf8               this
  #100 = Utf8               Lext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent;
  ...
  #116 = Utf8               <clinit>
  #117 = Utf8               SourceFile
  #118 = Utf8               AdminCTFEvent.java
{
  public ext.mods.gameserver.handler.admincommandhandlers.AdminCTFEvent();
    descriptor: ()V
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent;
  ...
  public void useAdminCommand(java.lang.String, ext.mods.gameserver.model.actor.Player);
    ...
    Code:
      stack=4, locals=5, args_size=3
        ...
        53: goto          127
        56: aload_1
        57: ldc           #35                 // String admin_ctf_remove
       ...
       109: goto          127
       112: aload_1
       113: ldc           #40                 // String admin_ctf_advance
       115: invokevirtual #9                  // Method java/lang/String.startsWith:(Ljava/lang/String;)Z
       118: ifeq          127
       121: invokestatic  #42                 // Method ext/mods/gameserver/model/entity/events/capturetheflag/CTFManager.getInstance:()Lext/mods/gameserver/model/entity/events/capturetheflag/CTFManager;
       124: invokevirtual #48                 // Method ext/mods/gameserver/model/entity/events/capturetheflag/CTFManager.skipDelay:()V
       127: return
      LineNumberTable:
        line 40: 0
        line 42: 9
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
          ...
          102       7     4   plr   Lext/mods/gameserver/model/actor/Player;
            0     128     0  this   Lext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent;
  ...
  public java.lang.String[] getAdminCommandList();
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       4     0  this   Lext/mods/gameserver/handler/admincommandhandlers/AdminCTFEvent;
  ...
  static {};
    ...
    Code:
      stack=4, locals=0, args_size=0
         ...
         4: dup
         5: iconst_0
         6: ldc           #7                  // String admin_ctf_add
         8: aastore
         9: dup
        10: iconst_1
        11: ldc           #35                 // String admin_ctf_remove
        13: aastore
        14: dup
        15: iconst_2
        16: ldc           #40                 // String admin_ctf_advance
        18: aastore
