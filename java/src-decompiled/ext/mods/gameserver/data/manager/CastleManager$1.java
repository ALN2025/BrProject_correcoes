// Bytecode for: ext.mods.gameserver.data.manager.CastleManager$1
// File: ext\mods\gameserver\data\manager\CastleManager$1.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/gameserver/data/manager/CastleManager$1.class
  Last modified 9 de jul de 2026; size 778 bytes
  MD5 checksum 0b67f6546ffd2e72acf2517c939b3098
  Compiled from "CastleManager.java"
class ext.mods.gameserver.data.manager.CastleManager$1
  minor version: 0
  major version: 69
  flags: (0x1020) ACC_SUPER, ACC_SYNTHETIC
  this_class: #8                          // ext/mods/gameserver/data/manager/CastleManager$1
...
Constant pool:
   ...
   #7 = Fieldref           #8.#9          // ext/mods/gameserver/data/manager/CastleManager$1.$SwitchMap$ext$mods$gameserver$enums$CabalType:[I
   #8 = Class              #10            // ext/mods/gameserver/data/manager/CastleManager$1
   #9 = NameAndType        #11:#12        // $SwitchMap$ext$mods$gameserver$enums$CabalType:[I
  #10 = Utf8               ext/mods/gameserver/data/manager/CastleManager$1
  ...
  #34 = Utf8               SourceFile
  #35 = Utf8               CastleManager.java
  #36 = Utf8               EnclosingMethod
  #37 = Class              #38            // ext/mods/gameserver/data/manager/CastleManager
  #38 = Utf8               ext/mods/gameserver/data/manager/CastleManager
  #39 = Utf8               NestHost
...
EnclosingMethod: #37.#0                 // ext.mods.gameserver.data.manager.CastleManager
NestHost: class ext/mods/gameserver/data/manager/CastleManager
InnerClasses:
  static #8;                              // class ext/mods/gameserver/data/manager/CastleManager$1
