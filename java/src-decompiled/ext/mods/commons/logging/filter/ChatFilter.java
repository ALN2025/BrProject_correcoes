// Bytecode for: ext.mods.commons.logging.filter.ChatFilter
// File: ext\mods\commons\logging\filter\ChatFilter.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/commons/logging/filter/ChatFilter.class
  Last modified 9 de jul de 2026; size 676 bytes
  MD5 checksum 2592dd20fdeb590e4957730ccd93f7c9
  Compiled from "ChatFilter.java"
public class ext.mods.commons.logging.filter.ChatFilter implements java.util.logging.Filter
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #21                         // ext/mods/commons/logging/filter/ChatFilter
...
Constant pool:
  ...
  #21 = Class              #22            // ext/mods/commons/logging/filter/ChatFilter
  #22 = Utf8               ext/mods/commons/logging/filter/ChatFilter
  ...
  #28 = Utf8               this
  #29 = Utf8               Lext/mods/commons/logging/filter/ChatFilter;
  #30 = Utf8               isLoggable
  #31 = Utf8               (Ljava/util/logging/LogRecord;)Z
  #32 = Utf8               logRecord
  #33 = Utf8               Ljava/util/logging/LogRecord;
  #34 = Utf8               SourceFile
  #35 = Utf8               ChatFilter.java
{
  public ext.mods.commons.logging.filter.ChatFilter();
    descriptor: ()V
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lext/mods/commons/logging/filter/ChatFilter;
  ...
  public boolean isLoggable(java.util.logging.LogRecord);
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0      10     0  this   Lext/mods/commons/logging/filter/ChatFilter;
