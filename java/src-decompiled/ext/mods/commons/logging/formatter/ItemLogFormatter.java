// Bytecode for: ext.mods.commons.logging.formatter.ItemLogFormatter
// File: ext\mods\commons\logging\formatter\ItemLogFormatter.class

Classfile /c:/Users/User/Desktop/BrProject/bin/main/ext/mods/commons/logging/formatter/ItemLogFormatter.class
  Last modified 9 de jul de 2026; size 2306 bytes
  MD5 checksum 1b823cecbafec9711f1fb683525d6e60
  Compiled from "ItemLogFormatter.java"
public class ext.mods.commons.logging.formatter.ItemLogFormatter extends ext.mods.commons.logging.MasterFormatter
  minor version: 0
  major version: 69
  flags: (0x0021) ACC_PUBLIC, ACC_SUPER
  this_class: #21                         // ext/mods/commons/logging/formatter/ItemLogFormatter
...
Constant pool:
   ...
   #18 = Utf8               getMillis
   #19 = Utf8               ()J
   #20 = Methodref          #21.#22       // ext/mods/commons/logging/formatter/ItemLogFormatter.getFormatedDate:(J)Ljava/lang/String;
   #21 = Class              #23           // ext/mods/commons/logging/formatter/ItemLogFormatter
   #22 = NameAndType        #24:#25       // getFormatedDate:(J)Ljava/lang/String;
   #23 = Utf8               ext/mods/commons/logging/formatter/ItemLogFormatter
   ...
   #81 = Utf8               this
   #82 = Utf8               Lext/mods/commons/logging/formatter/ItemLogFormatter;
   #83 = Utf8               format
  ...
  #114 = Utf8               Lookup
{
  public ext.mods.commons.logging.formatter.ItemLogFormatter();
    descriptor: ()V
    ...
    Code:
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
            0       5     0  this   Lext/mods/commons/logging/formatter/ItemLogFormatter;
      ...
      LocalVariableTable:
        Start  Length  Slot  Name   Signature
           ...
           73     119     6     p   Ljava/lang/Object;
            0     210     0  this   Lext/mods/commons/logging/formatter/ItemLogFormatter;
            0     210     1 logRecord   Ljava/util/logging/LogRecord;
            8     202     2    sb   Ljava/lang/StringBuilder;
      StackMapTable: number_of_entries = 7
        frame_type = 255 /* full_frame */
          offset_delta = 60
          locals = [ class ext/mods/commons/logging/formatter/ItemLogFormatter, class java/util/logging/LogRecord, class java/lang/StringBuilder, class "[Ljava/lang/Object;", int, int ]
          stack = []
        ...
        frame_type = 255 /* full_frame */
          offset_delta = 72
          locals = [ class ext/mods/commons/logging/formatter/ItemLogFormatter, class java/util/logging/LogRecord, class java/lang/StringBuilder, class "[Ljava/lang/Object;", int, int, class java/lang/Object, class ext/mods/gameserver/model/item/instance/ItemInstance ]
