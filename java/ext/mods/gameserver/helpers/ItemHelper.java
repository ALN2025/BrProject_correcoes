...
public class ItemHelper {
    ...
    public static boolean canSeeItemId(Player player) {
        ...
        return player.getAccessLevel() != null && player.getAccessLevel().getLevel() >= minLevel;
    }
    ...
    public static boolean isAdmin(Player player) {
        return player != null && player.getAccessLevel() != null && player.getAccessLevel().getLevel() >= 1;
    }
}