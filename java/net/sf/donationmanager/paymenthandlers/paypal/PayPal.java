...
package net.sf.donationmanager.paymenthandlers.paypal;
...
import net.sf.donationmanager.IPaymentHandler;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.BillingInfo;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.Detail;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.Invoicer;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.Item;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.PaymentTerm;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.Phone;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.Recipient;
import net.sf.donationmanager.paymenthandlers.paypal.Invoice.UnitAmount;
