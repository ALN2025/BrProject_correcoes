...
%JAVA_HOME% -Xms256m -Xmx512m -Dext.mods.gameserver.data.AbstractLocaleData.BASE_LOCALE_PATH=html -Dsun.java2d.opengl=false -Dsun.java2d.d3d=false -Dsun.java2d.pmoffscreen=false -Dbrproject.safe.graphics=true -cp "libs/*" ext.mods.security.LicenseInit
pause