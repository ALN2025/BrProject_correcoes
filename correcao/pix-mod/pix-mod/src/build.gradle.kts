...
// compileJava le libs/*.jar gerados/copiados por copyDependencies — Gradle 9 exige dependsOn explicito
val copyDependenciesTask = tasks.named<Copy>("copyDependencies")
tasks.named<JavaCompile>("compileJava") {
